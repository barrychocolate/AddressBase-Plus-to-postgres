...
--copy *.csv building_heights.csv

--Load the building Heights data
copy os_address.building_heights (os_topo_toid, os_topo_toid_version, bha_processdate, tileref, abshmin, absh2, abshmax, relh2, relhmax, bha_conf ) FROM 'C:\temp\OS\bldhgb_csv\Data\building_heights.csv' WITH delimiter ',' quote '"' ESCAPE '"' csv;

--create an index on OS_TOPO_TOID
